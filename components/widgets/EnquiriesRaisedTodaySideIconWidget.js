...
export const EnquiriesRaisedTodaySideIconWidget = () => {
  ...
  const data = {
    level: 'GREEN',
    message: `heading:Enquiries raised today;quantity:${getRandomArbitrary(6, 30)};value:${getRandomArbitrary(9000, 12000)}`,
  };
